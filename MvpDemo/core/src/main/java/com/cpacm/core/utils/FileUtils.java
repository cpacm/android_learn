...
public class FileUtils {
    ...
    public final static String CACHE_DIR = "sfreader";
    public final static String GLIDE_CACHE_DIR = "glide";
    public final static String SONG_CACHE_DIR = "songs";
    public final static String NETWORK_CACHE_DIR = "NetCache";

    public final static String APK_NAME = "zqsw.apk";
    ...
    public static String getNetCacheDir() {
        String net_path = getCacheDir() + File.separator + NETWORK_CACHE_DIR;
        return net_path;
    }
    ...
    private static File getCacheFile() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            cache = CoreApplication.getInstance().getExternalCacheDir();
        } else {
            cache = CoreApplication.getInstance().getCacheDir();
        }
        return cache;
    }
